      ...
      <div style={{ position: "relative", zIndex: 1 }} className="fade-in">
          ...
          <div style={{ maxWidth: 720, margin: "0 auto", padding: "60px 24px" }}>
            <div style={{ textAlign: "center", marginBottom: 60 }}>
              ...
              <h1 style={{ fontSize: "clamp(36px, 8vw, 64px)", fontWeight: 900, lineHeight: 1.1, marginBottom: 16 }}>
                AIが作る<br />
                <span style={{ color: accentColor }}>あなただけの</span><br />
                問題集
              </h1>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginBottom: 48 }}>
              {[
                { icon: "🤖", title: "AI生成", desc: "毎回ユニークな問題" },
                { icon: "⚡", title: "即座に", desc: "待ち時間ゼロ" },
                { icon: "📈", title: "レベル別", desc: "基礎〜難関まで" },
              ].map(f => (
            ...
            <div style={{ textAlign: "center" }}>
              <button style={{ ...styles.btnPrimary, fontSize: 18, padding: "18px 48px" }} onClick={() => setScreen("config")}>
                学習をはじめる →
              </button>
            </div>
          </div>
          ...
          <div style={{ maxWidth: 720, margin: "0 auto", padding: "48px 24px" }}>
                ...
                {SUBJECTS.map(s => (
                  <div key={s.id} className="subject-card"
                    style={{
                      ...
                      padding: "20px 12px",
                      textAlign: "center",
                      border: subject === s.id ? `2px solid ${s.color}` : "1px solid rgba(255,255,255,0.08)",
                    }}
                ...
                {LEVELS.map(l => (
                  <div key={l.id} className="subject-card"
                    style={{
                      ...
                      padding: 16,
                      cursor: "pointer",
                      border: level === l.id ? `2px solid ${accentColor}` : "1px solid rgba(255,255,255,0.08)",
                    }}
            ...
            <div style={{ marginBottom: 40 }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                {[3, 5, 10].map(n => (
                  <button key={n}
                    style={{ ...(quizCount === n ? styles.btnPrimary : styles.btnGhost), flex: 1 }}
                    onClick={() => setQuizCount(n)}>{n}問</button>
                ))}
              </div>
            </div>
          ...
          <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 24px" }}>
            ...
            <div style={{ marginBottom: 8 }}>
              ...
              <div className="progress-bar">
                <div className="progress-fill" style={{ width: `${(answers.length / questions.length) * 100}%` }} />
              </div>
            </div>
                  ...
                  {currentQ.choices.map((ch, i) => {
                    ...
                    return (
                      <button key={i} className={cls} disabled={selected !== null} onClick={() => handleSelect(i)}>
                        <span style={{ fontFamily: "'Space Mono', monospace", fontSize: 13, color: accentColor, marginRight: 12 }}>
        ...
        {screen === "result" && (
          <div style={{ maxWidth: 600, margin: "0 auto", padding: "60px 24px", textAlign: "center" }}>
            <div className="fade-in">
              <div style={{ fontSize: 80, fontWeight: 900, color: accentColor, fontFamily: "'Space Mono', monospace", lineHeight: 1, marginBottom: 8 }}>
                {pct}%
              </div>
                  ...
                  return (
                    <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12, padding: "12px 0", borderBottom: i < questions.length - 1 ? "1px solid rgba(255,255,255,0.06)" : "none" }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {!ans?.correct && (
                          <div style={{ fontSize: 13, color: "#4ECDC4", marginTop: 4 }}>正解: {q.choices[q.answer]}</div>
                        )}
                      </div>
                    </div>
                  );
